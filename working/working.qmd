...
とある物体が質量 $m$ ，速度 $\symbfit{v}$ を持っている時，その物体の運動量 $\symbfit{p}$ を次のように定義する．
...
::: {.Qbox data-latex="{斜面付き台からの飛び出し}{3}{}"}
...
::: {.Qbox data-latex="{台上の物体の跳び上がり}{4}{東京大}"}
